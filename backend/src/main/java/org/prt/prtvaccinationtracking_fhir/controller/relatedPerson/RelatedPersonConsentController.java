...
import org.prt.prtvaccinationtracking_fhir.service.relatedPerson.RelatedPersonConsentService;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping("/api/relatedPerson/consents")
public class RelatedPersonConsentController {

    private final RelatedPersonConsentService service;

    public RelatedPersonConsentController(RelatedPersonConsentService service) {
