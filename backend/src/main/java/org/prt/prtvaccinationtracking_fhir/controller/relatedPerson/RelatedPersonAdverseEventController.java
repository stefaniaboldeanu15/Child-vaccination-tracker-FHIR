...
import org.prt.prtvaccinationtracking_fhir.service.relatedPerson.RelatedPersonAdverseEventService;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping("/api/related-person/adverse-events")
public class RelatedPersonAdverseEventController {

    private final RelatedPersonAdverseEventService service;

    public RelatedPersonAdverseEventController(RelatedPersonAdverseEventService service) {
