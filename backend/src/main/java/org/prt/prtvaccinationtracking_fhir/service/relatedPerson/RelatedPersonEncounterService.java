...
import org.prt.prtvaccinationtracking_fhir.mapper.relatedPerson.RelatedPersonEncounterMapper;
import org.springframework.stereotype.Service;

@Service
public class RelatedPersonEncounterService {

    private final FhirGateway fhir;
    private final RelatedPersonEncounterMapper mapper;

    public RelatedPersonEncounterService(FhirGateway fhir, RelatedPersonEncounterMapper mapper) {
        this.fhir = fhir;
        this.mapper = mapper;
    }
