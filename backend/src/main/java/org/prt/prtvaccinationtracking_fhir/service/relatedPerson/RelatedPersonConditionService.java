...
import org.prt.prtvaccinationtracking_fhir.mapper.relatedPerson.RelatedPersonConditionMapper;
import org.springframework.stereotype.Service;

@Service
public class RelatedPersonConditionService {

    private final FhirGateway fhir;
    private final RelatedPersonConditionMapper mapper;

    public RelatedPersonConditionService(FhirGateway fhir, RelatedPersonConditionMapper mapper) {
        this.fhir = fhir;
        this.mapper = mapper;
    }
