...
@Component
public class RelatedPersonObservationMapper {

    private final RelatedPersonMapperSupport support;

    public RelatedPersonObservationMapper(RelatedPersonMapperSupport support) {
    ...
    private CodeableConcept toCodeableConcept(String code, String display) {
