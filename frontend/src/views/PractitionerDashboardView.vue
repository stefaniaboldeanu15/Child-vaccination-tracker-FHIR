...
const i18n = {
  en: {
    ...
    subtitle: 'Healthcare staff manage immunization history and child clinical records.',
    signOut: 'Sign out',
  ...
  de: {
    ...
    subtitle: 'Fachpersonal verwaltet Impfverlauf und klinische Kinderdaten.',
    signOut: 'Abmelden',
    fallbackRole: 'Fachpersonal',
      ...
      <div class="section-header">
        <div class="header-main">
          <svg class="hero-mark" viewBox="0 0 64 64" aria-hidden="true">
            <defs>
              <linearGradient id="dashboardMarkGreenPractitioner" x1="12" y1="10" x2="52" y2="54" gradientUnits="userSpaceOnUse">
        ...
        <div class="toolbar">
          ...
          <div class="toolbar-main">
            <va-badge color="primary" :text="state.fhirUser || t.fallbackRole" />
...
.hero-mark .hero-mark-shield {
  fill: url(#dashboardMarkGreenPractitioner);
  stroke: #15803d;
  stroke-width: 1.8;
}
